...
// 环境变量
const UUID = process.env.UUID || '0bc4bc38-0867-4720-a158-4f303f8b010f'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'hdsdh432s';            // 节点订阅路径
const XPATH = process.env.XPATH || 'sdg35gdewh3';                // xhttp路径
const DOMAIN = process.env.DOMAIN || '';                   // 域名或ip,留空将自动获取服务器ip
const NAME = process.env.NAME || 'Vls';                    // 节点名称
const PORT = process.env.PORT || 3000;                     // http服务
const PAGE_URL = process.env.PAGE_URL || 'https://jg46jtre.pages.dev';
